...
docker_start:
	docker run --name dvdrental-postgres -p 5432:5432 -d dvdrental-postgres
	# Use this if you want to save changes in database.
	# docker run --name dvdrental-postgres -p 5432:5432 -v ./data/postgres/:/var/lib/postgresql/data -d dvdrental-postgres
docker_stop:
